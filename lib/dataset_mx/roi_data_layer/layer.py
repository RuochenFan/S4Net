...
from dataset_mx.roi_data_layer.minibatch import get_minibatch
import numpy as np
import time
...
class RoIDataLayer(object):
    ...
    def _get_next_minibatch(self, is_reshape=True):
    ...
    def forward(self, is_reshape=True):
        """Get blobs and copy them into this layer's top blob vector."""
        blobs = self._get_next_minibatch(is_reshape=is_reshape)
        return blobs